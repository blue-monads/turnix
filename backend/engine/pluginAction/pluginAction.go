...
func (p *PluginAction) Run(pid, plugId int64, name string, data map[string]any) (any, error) {
...
func (p *PluginAction) LiveRun(pid int64, name, source string, data map[string]any) (any, error) {
